...
def generate_citation(
    ...
    Input names follow esmcat column names, as strings.
...
def df_to_citations(df: pd.DataFrame) -> pd.DataFrame:
    """Generate data citations from an esmcat dataframe.

    Input: dataframe of model runs generated by esmcat
...
if __name__ == "__main__":
    ...
    # Get some data with esmcat
    catlg = ecat.catalogue(
        dataset="cmip6",
